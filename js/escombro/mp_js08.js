...
/*
    ...
    function mapaProcesos_procesos(jsonObj) {
        ...
        for (var i = 0; i < datos_mp_content.length; i++) {
            mapaProcesos_contenido_procesos_niveles_pruebas(datos_mp_content,i,datos_mp_procesos);
        }
    }


    //NIVEL: mp.i.jj XXXX
    function mapaProcesos_contenido_procesos_niveles_pruebas(jsonObj,cont1,dentro_de) {
        var datos_mp_fullcontent = jsonObj;
        var i = cont1;
