$(document).ready(function(){
    ...
    var requestURL = 'json/datos_mp2_pruebas_v4.json';
        ...
        for (var j = 0; j < datos_mp_content.length; j++) {
            ...
            if (result_nivel_sindecimal[0] == "2"){
                if (result_nivel_sindecimal[1] == "01"){
                    ...
                    sub_mapa2_div1.attr("id","mapa_"+datos_mp_content[j].nivel);
                    sub_mapa2_div1.attr("onclick","func_mapa_"+datos_mp_content[j].nivel+"()");
                ...
                if ((result_nivel_sindecimal[1]=="02")||(result_nivel_sindecimal[1]=="05")){
                    ...
                    sub_mapa2_div3_div1.attr("id","mapa_"+datos_mp_content[j].nivel);
                    sub_mapa2_div3_div1.attr("onclick","func_mapa_"+datos_mp_content[j].nivel+"()");
                ...
                if ((result_nivel_sindecimal[1]=="03")||(result_nivel_sindecimal[1]=="06")){
                    ...
                    sub_mapa2_div3_div2.attr("id","mapa_"+datos_mp_content[j].nivel);
                    sub_mapa2_div3_div2.attr("onclick","func_mapa_"+datos_mp_content[j].nivel+"()");
                ...
                if ((result_nivel_sindecimal[1] == "04")||(result_nivel_sindecimal[1] == "07")){
                    ...
                    sub_mapa2_div5.attr("id","mapa_"+datos_mp_content[j].nivel);
                    sub_mapa2_div5.attr("onclick","func_mapa_"+datos_mp_content[j].nivel+"()");
    ...
    function mapaProcesos_contenido_procesos_niveles(jsonObj,cont1,dentro_de){
        ...
        if (datos_mp_fullcontent_sub){
            if (!((datos_mp_fullcontent_sub == "")||(datos_mp_fullcontent_sub == []))){
                ...
                txt_procesos111.attr("id","bc_contenedor_internos_titulo_"+datos_mp_fullcontent[i].nivel);
                txt_procesos111.text(datos_mp_fullcontent[i].nombre);
                txt_procesos11.append(txt_procesos111);*/

                var txt_procesos111 = $("<div>");
                txt_procesos111.addClass("class_esquema_titulo");
                txt_procesos111.addClass("bc_mp_a");
                txt_procesos111.attr("id","bc_contenedor_internos_titulo_"+datos_mp_fullcontent[i].nivel);
                txt_procesos111.attr("onclick","func_contenedor_internos_titulo_"+datos_mp_fullcontent[i].nivel+"()");
                txt_procesos111.text(datos_mp_fullcontent[i].nombre);
                txt_procesos11.append(txt_procesos111);
                ...
                for (var j = 0; j < datos_mp_fullcontent_sub.length; j++) {
                    ...
                    if (!(esta_vacio(datos_mp_fullcontent_sub[j]))){
                        mapaProcesos_contenido_procesos_niveles(datos_mp_fullcontent_sub,j,dentro_de);
                    }
                }
            }
        }
